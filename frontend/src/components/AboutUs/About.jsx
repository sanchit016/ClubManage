  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="" style={{ width: "40%", padding: "5%" }}>
            <img
              ...
              alt=" image1"
              style={{ height: "310px", borderRadius: "50%" }}
            />
          </div>
          <div style={{ width: "40%", padding: "2%" }}>
            <h2 className="mb-5">Training And Placement Cell(TPC)</h2>
            <p>
        ...
        >
          <div style={{ width: "40%", padding: "2%" }}>
            <h2 className="mb-5">Brand And Promotion Comittee(BPC)</h2>
            <p>
        ...
        >
          <div className="" style={{ width: "40%", padding: "5%" }}>
            <img
              ...
              alt=" image1"
              style={{ height: "310px", width: "350px", borderRadius: "50%" }}
            />
          </div>
          <div style={{ width: "40%", padding: "2%" }}>
            <h2 className="mb-5">Goonj</h2>
            <p>
