  ...
  return (
    ...
    <div className="container">
        <div className="row">
            ...
            <h1 className="display-4" style={{ color: '#21e6c1', fontWeight:'400' }}>What's on the Calendar?</h1>
                <p className="lead mb-0" style={{ color: 'white' }}>Our past and upcoming events</p>
            </div>
            <div className="car-btns">
                <a className="btn  mb-3 mr-1" style={{ backgroundColor: '#278ea5' }} href="#carouselExampleIndicators2" role="button" data-slide="prev">
                    <i className="fa fa-arrow-left"></i>
                </a>
                <a className="btn mb-3 " style={{ backgroundColor: '#278ea5' }} href="#carouselExampleIndicators2" role="button" data-slide="next">
                        ...
                        <div className="carousel-item active">
                            <div className="row">
                                ...
                                <div className="col-md-4 mb-3">
                                    <div className="card" style={{ backgroundColor: '#278ea5', color: 'white' }}>
